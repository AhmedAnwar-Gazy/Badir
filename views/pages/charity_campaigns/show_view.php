...
<main class="main_show_ch">
    ...
    <section id="main-campaign-section" class="card_islamic_endowments">
        ...
        <div class="imgs">
            <img src="views/media/images/<?php echo $campaigns['0']['photo'] ?? "11.png" ?>" alt="صورة الحملة المستهدفة" loading="lazy">
        </div>
            ...
            <div class="donation-box">
                <div class="donate-section">
                    <form action="/charity_campaigns_checkout" method="get" class="donate-section">
                        ...
                        <input type="hidden" name="campaign_id" value="<?= htmlspecialchars($campaigns['0']['campaign_id']) ?>">
...
<div class="details_show_ch">
    ...
    <p>المرحلة الثالثة :</p>
        ...
        <div class="news">
            <h5>اخبار المشروع</h5>
            <div>
                <p>تم جمع <?= htmlspecialchars( number_format( (($campaigns['0']['collected_money'] / $campaigns['0']['cost']) * 100) ,2 )) ?>% من التبرعات</p>
            </div>
